export interface StateData {
  ...
  export const nigerianStatesLGAs: StateData[] = [
    {
      name: "Abia",
    ...
    {
      name: "Niger",
      lgas: ["Agaie", "Agwara", "Bida", "Borgu", "Bosso", "Chanchaga", "Edati", "Gbako", "Gurara", "Katcha", "Kontagora", "Lapai", "Lavun", "Magama", "Mariga", "Mashegu", "Mokwa", "Moya", "Paikoro", ""]
    },
    {
        name: "Ogun",
