...
import { Search, MapPin, CalendarDays, CircleAlert, ChevronDown } from 'lucide-react';
...
const EventsTab: React.FC<EventsTabProps> = ({ nigerianStates }) => {
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                const response = await fetch('https://ican-api-6000e8d06d3a.herokuapp.com/api/events', {
                    method: 'GET',
                    headers: {
    ...
    const filteredEvents = events.filter(event => {
        ...
        const matchesLocation = selectedLocation ? event.venue.includes(selectedLocation) : true;
                ...
                <div className="flex flex-row w-1/2 gap-4 ">
                    <div className="w-1/2 location-dropdown-container">
                        <div className="relative group flex-1">
                            ...
                            >
                                <span className={selectedLocation ? "text-black" : "text-black"}>
