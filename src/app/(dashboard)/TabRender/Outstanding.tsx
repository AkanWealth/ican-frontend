...
// import apiClient from "@/services/apiClient";
// import { parseCookies } from "nookies";
// // Comment out PaymentModal import but keep it for future use
// // import PaymentModal from "@/components/Modal/PaymentModal";
// import paymentService from "@/services/PaymentService";
...
//   // Handle payment success - commented out but kept for future reference
//   /*
//   const handlePaymentSuccess = async (paymentData: {
//     billingId: string;
//     paymentType: string;
...
//   // Handle settle all payments - commented out but kept for future reference
//   /*
//   const handleSettleAllPayments = async (paymentData: {
//     paymentType: string;
//     amount: number;
...
//   // Modified: Open payment modal - replaced with toast notification
//   const handleOpenPaymentModal = (payment: any) => {
//     // Show toast notification instead of opening payment modal
//     toast({
//       title: "Payment Feature Unavailable",
//       description: "The payment feature is not available at this time. Please try again later.",
//       variant: "destructive",
//       duration: 3000,
//     });
    
//     // Original code kept but commented out
//     /*
//     setSelectedBillingId(payment.id);
//     setPaymentAmount(parseFloat(payment.amountLeft || payment.AmountDue));
//     setIsPaymentModalOpen(true);
...
//   // Modified: Handle "Settle Payment" for selected items - replaced with toast notification
//   const handleSelectPayment = () => {
//     // Show toast notification
//     toast({
//       title: "Payment Feature Unavailable",
//       description: "The bulk payment feature is not available at this time. Please try again later.",
//       variant: "destructive",
//       duration: 3000,
//     });
    
//     // Keep original code but commented out
//     /*
//     if (selectedItems.length === 0) {
//       toast({
//         title: "No Items Selected",
...
//   // Modified: Handle "Settle All Payment" - replaced with toast notification
//   const handleSettleAllPayment = () => {
//     // Show toast notification
//     toast({
//       title: "Payment Feature Unavailable",
//       description: "The settle all payments feature is not available at this time. Please try again later.",
//       variant: "destructive",
//       duration: 3000,
//     });
...
//   // Commented out payment modal rendering
//   /*
//   // Render payment modal
//   const renderPaymentModal = () => {
//     if (!isPaymentModalOpen) return null;
