...
import { Search, ChevronDown, ListFilter, ChevronUp, Bookmark } from 'lucide-react';
...
function ResourcePage() {
    ...
    const handleSortSelect = (sortOption: string) => {
        ...
        if (sortOption === 'Latest') {
            ...
            // Sort by most viewed (would need view count in real implementation)
            // For now, just demonstrate the sort works
    ...
    return (
        <div className="p-4 md:p-8 bg-white rounded-lg border border-gray-300">
            ...
            <div className="w-full mb-4">
                <div className='w-[405px] bg-gray-200 rounded-xl p-2'>
                    <button
                        onClick={() => handleTabChange('resource')}
                        className={`sm:w-auto text-xs px-8 py-2 rounded-lg hover:bg-blue-700 ${activeTab === 'resource'
                    ...
                    <button
                        ...
                        className={`sm:w-auto text-xs px-8 py-2 rounded-lg ${activeTab === 'recommended'
                            ? 'bg-primary text-white'
                            : 'text-gray-800 hover:bg-gray-300'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`sm:w-auto text-xs px-8 py-2 rounded-lg ${activeTab === 'bookmark'
                            ? 'bg-primary text-white'
                            : 'text-gray-800 hover:bg-gray-300'
                            }`}
                    >
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
                <div className="relative w-full md:w-1/2">
                    ...
                    <input
                        ...
                        className="w-full h-10 pl-10 pr-4 rounded-lg border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 placeholder:text-black"
                    />
                </div>
