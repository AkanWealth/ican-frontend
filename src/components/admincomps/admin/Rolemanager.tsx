...
const PERMISSION_MATRIX = [
  ...
  },
  {
    ...
    actions: [
      ...
      {
        label: "View",
        value: `"VIEW_ALL_BLOGS" , "VIEW_ALL_CONTENT", "VIEW_ALL_FAQ", "VIEW_ALL_GALLERY" , "VIEW_ALL_STUDYPACKS" , "VIEW_ALL_TECHNICAL_SESSION", "VIEW_BLOG" , "VIEW_CONTENT", "VIEW_FAQ", "VIEW_GALLERY", "VIEW_STUDYPACK", "VIEW_TECHNICAL_SESSION" `,
      },
      {
        label: "Manage",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const selectedPermissionValues = permissions
      ...
      .concat([
        ...
        "MAKE_DONATION",
      ]) // Add default role viewing permissions
