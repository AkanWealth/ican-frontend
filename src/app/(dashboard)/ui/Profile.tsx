...
function Profile() {
  ...
  const renderBiodata = () => (
    ...
    </div><hr className="mb-8 border-gray-400" /><form onSubmit={handleSubmit}>
        {/* Biodata Section */}
        <div className="w-full mb-8 flex flex-col md:flex-row md:gap-40">
          ...
          <div className="w-full md:w-[70%] space-x-8">
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-1 gap-10">
              ...
              <div>
                <label htmlFor="stateOfOrigin" className="block text-base font-semibold mb-2">
                  State of origin
                </label>
                <select
                  id="stateOfOrigin"
              ...
              <div>
                <label htmlFor="nationality" className="block text-base font-semibold mb-2">
                  Nationality
                </label>
                <select
                  id="nationality"
  ...
  const renderContactDetails = () => (<>
    <div className="w-full mb-8 flex flex-col md:flex-row md:gap-[6.5rem]">
      ...
      <div className="w-full md:w-[60%] grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div>
          <label htmlFor="residentialCountry" className="block text-base font-semibold mb-2">
            Residential Country
          </label>
          <select
        ...
        <div>
          <label htmlFor="residentialState" className="block text-base font-semibold mb-2">
            Residential State
          </label>
          <select
            id="residentialState"
        ...
        <div>
          <label htmlFor="residentialCity" className="block text-base font-semibold mb-2">
            Residential City
          </label>
          <select
            id="residentialCity"
        ...
        <div>
          <label htmlFor="residentialLGA" className="block text-base font-semibold mb-2">
            Residential LGA
          </label>
          <select
            id="residentialLGA"
  ...
  const renderEducationDetail = () => (<>
    <div className="w-full mb-8 flex flex-col md:flex-row md:gap-[3rem]">
      <h2 className="text-base font-medium mb-4 md:w-[15%]">Educational and Professional Qualififcation</h2>
      <div className="w-full md:w-[60%] grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
        ...
        <div>
          ...
          >
            ...
            <option value="BScEdu">Bachelor of Science Education(BSc Edu) Education</option>
  ...
  const renderWorkExperience = () => (<>
    <div className="w-full mb-8 flex flex-col md:flex-row md:gap-[3rem]">
    <h2 className="text-base font-medium mb-4 md:w-[15%]">Work Experience</h2>
      <div className='md:w-[60%] grid grid-cols-1 sm:grid-cols-2 gap-6'>
        <div>
          <label htmlFor="country" className="block text-base font-semibold mb-2">
            Name of Company
  ...
  return (
    ...
    <div className="p-4 bg-white rounded-lg border border-gray-300 ">
      ...
      <hr className="mb-8 border-gray-400" /><form onSubmit={handleSubmit}></form>
