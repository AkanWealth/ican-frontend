...
function Personal({ formData, updateFormData }: PersonalProps) {
  ...
  return (
    <div className="pt-4 flex flex-col justify-between gap-4 mt-4">
      ...
      <div className="flex flex-col items-center justify-center mb-6">
        <div
          className={`w-32 h-32 rounded-full bg-[#F7F7F7] flex items-center justify-center mb-4 cursor-pointer border-2 ${
            !formData.profilePicture ? 'border-red-300 border-dashed' : 'border-gray-200'
          }`}
          onClick={handleUploadClick}
        >
          {formData.profilePicture ? (
