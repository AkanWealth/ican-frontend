...
const CertificateGenerator: React.FC<CertificateGeneratorProps> = ({
  ...
  const [certificateId] = useState(Math.floor(100000 + Math.random() * 900000).toString());
  const [eventDate] = useState(new Date().toLocaleDateString('en-GB', {
    day: '2-digit',
    month: '2-digit',
    year: 'numeric',
  }));
  ...
  const generateAndDownloadCertificate = async () => {
    ...
    try {
      ...
      link.href = image;
      link.download = `ICAN_Certificate_${userData.surname.replace(/\s+/g, '_')}.png`;
      link.click();
              ...
              <div className="relative z-10 flex flex-col items-center justify-between h-full py-6 space-y-4">
                ...
                <div className="text-center items-center">
                  <div className='flex justify-center mb-8'>
                    <Image src="/Icanlogo.png" alt="ICAN Logo" className="w-auto item-center" width={200}
                      height={100} />

                  </div>
                  <div className='flex flex-col items-center justify-center mb-12'><h1 className="text-3xl font-bold text-blue-900 mb-4">CERTIFICATE OF ATTENDANCE</h1>
                    <Image src="/ceriticateDesign.png" alt="ICAN certificate Logo" className=" item-center" width={323}
                      height={200} />
                  </div>
                  <div className="flex flex-col items-center justify-center mt-8 mb-4">
                    <p className="text-2xl font-bold mb-4">This is to recognize</p>
                    <p
                    ...
                    <p className={`text-3xl font-medium  my-4 text-gray-700 ${leagueSpartan.className}`}>for attending the {eventTitle}</p>
                  </div>
                ...
                <div className="w-full">
                  <div className="flex justify-center mt-2 mb-4">
                    <div className="text-center mx-4 my-12">
                      ...
                      <p className="mt-2 mb-2 font-bold  text-base text-primary">Adebayo Jegede</p>
                      <p className='text-xs text-blue-900'>President</p>
                    </div>
                    <div className="w-full text-center mx-8">
                      <Image src="/award-badge.png" alt="Signature" className="mb-2" width={153} // Set appropriate width
                        height={120} />
                    </div>
                    <div className="text-center mx-4 my-12">
                      <div className="w-32 border-t-2 border-black"></div>
                      <p className="mt-2 mb-2 font-bold text-primary text-base">Nngozi Essien</p>
