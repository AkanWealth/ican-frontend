...
function Payment({ formData, updateFormData }: PaymentProps) {
  ...
  const handleFileChange = (file: File) => {
    ...
    if (!isAcceptedType) {
      toast({
        title: "",
        description: "Please upload an image, PDF or document file for your receipt",
        variant: "destructive",
        duration: 2000,
      });
      return;
    ...
    <div className="pt-4 flex flex-col justify-between gap-4 mt-4">
      ...
      <div className="w-full h-fit flex flex-col gap-3">
        ...
        <div className="w-full h-fit flex flex-row gap-3">
          ...
          />
          <label className="text-base font-sans font-semibold" htmlFor="cardOption">
          ...
          />
          <label className="text-base font-sans font-semibold" htmlFor="bankOption">
          ...
          />
          <label className="text-base font-sans font-semibold" htmlFor="waiverOption">
      ...
      <div className="w-full flex flex-col gap-3">
        ...
        <p className="text-sm">Send your payment to the bank listed below and upload your receipt</p>
        ...
        <div className="mt-4">
          <label className="font-semibold text-sm">Upload your receipt <span className="text-red-500">*</span></label>
          <div
          ...
          >
            ...
            {uploadState === "complete" && (
              <div className="flex flex-cols items-center justify-center w-full">
                ...
                <p className="ml-4 text-sm text-gray-700">File upload complete</p>
              </div>
            )}
          </div>
        </div>
