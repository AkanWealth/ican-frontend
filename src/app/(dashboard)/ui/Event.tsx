    ...
    <div className="flex flex-col w-full">
      <div className="mb-4 flex items-center justify-between">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-38 bg-white z-50 text-xs border border-gray-300 rounded-lg text-gray-700 "
          >
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm text-gray-600">
                  Submission Date {feedback.timestamp}
                </p>
                {/* <div className="flex">
                                    {[1, 2, 3, 4, 5].map((star) => (
                                        <Star
        ...
        <div className="flex-grow flex items-center justify-center mt-40">
          <div className="text-center p-16">
            ...
            <p className="mt-2 text-sm text-gray-700 max-w-lg mx-auto px-14">
              You haven't submitted any feedback yet. Attend events and share
              your experiences!
            </p>
          </div>
        </div>
        ...
        <DropdownMenu>
          ...
          >
            <DropdownMenuItem
              ...
              onClick={() => setFilterType("Past events")}
            >
              Past events
            </DropdownMenuItem>
            <DropdownMenuItem
              className="transition-colors hover:bg-blue-100 p-2"
              onClick={() => setFilterType("Upcoming events")}
            >
              Upcoming events
            </DropdownMenuItem>
            <DropdownMenuItem
              className="transition-colors hover:bg-blue-100 p-2"
              onClick={() => setFilterType("Updated events")}
            >
              Updated events
            </DropdownMenuItem>
            <DropdownMenuItem
        ...
        <>
          <div className="grid grid-cols-2 gap-6 mt-8">
            {filterEvents(registered).map((registered) => (
              <div
                key={registered.id}
                className="rounded-lg relative border-l-4 border-green-600 p-4 bg-white"
              >
                <div className="">
                  <span
                    className={`rounded-full px-2 py-0.5 text-sm  ${
                      registered.IsAttended
                ...
                <div className="">
                  ...
                  <div className="flex item-center justify-end gap-2 ml-4">
                    <button
                      ...
                      className={
                        "px-6 py-2 rounded-full transition-colors border border-primary text-primary "
                      }
                    >
        ...
        <div className="w-[130px] mr-6">
          <div className="relative group flex-1">
            ...
            <input
              ...
              className="w-full h-8 pl-12 pr-4 rounded-xl  border border-gray-700
                       focus:outline-none  focus:ring-1 focus:ring-blue-500
                       text-base transition-colors text-black
                       placeholder:text-black"
            />
          ...
          {events.map((event) => (
            <div key={event.id} className="border rounded-lg relative">
              <div className="relative h-52 mb-4 rounded-lg overflow-hidden">
                ...
                />
                <div
                  className={`absolute flex flex-row top-4 right-4 text-primary bg-blue-50 rounded-full px-3 py-1 text-sm ${
                    event.isFull ? "text-red-600 bg-white font-semibold" : ""
                  }`}
                >
